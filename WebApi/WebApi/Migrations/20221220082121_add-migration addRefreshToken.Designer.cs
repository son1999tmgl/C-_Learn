...
namespace WebApi.Migrations
{
    ...
    [Migration("20221220082121_add-migration addRefreshToken")]
    partial class addmigrationaddRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Data.DTNguoiDung", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApi.Data.DTRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApi.Data.DTRefreshToken", b =>
                {
                    b.HasOne("WebApi.Data.DTNguoiDung", "NguoiDung")
                        .WithMany()
